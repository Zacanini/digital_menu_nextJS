...
export const mockPizzas: Pizza[] = [
  ...
  price: 58.90,
  imageUrl: '/image_pizzas/pizza-de-peperoni-premium.webp',
  categoryId: 'cat-001',
    isAvailable: true,
    isFeatured: false,
    preparationTime: 20,
  ...
  // === PIZZAS DOCES ===
  {
    ...
    price: 48.90,
    imageUrl: '/image_pizzas/morango_com_nutella.jpg',
    categoryId: 'cat-002',
    isAvailable: true,
    isFeatured: true,
    preparationTime: 15,
  ...
  price: 44.90,
  imageUrl: '/image_pizzas/pizza-de-romeu-e-julieta.webp',
  categoryId: 'cat-002',
    isAvailable: true,
    isFeatured: false,
    preparationTime: 18,
  ...
  price: 58.90,
  imageUrl: '/image_pizzas/pizza-vegana-tropical.jpg',
  categoryId: 'cat-003',
    isAvailable: true,
    isFeatured: false,
    preparationTime: 18,
